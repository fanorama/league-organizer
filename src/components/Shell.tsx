...
interface ShellProps {
  active: 'leagues' | 'competitions' | 'players' | 'quick-match' | 'clubs';
  title: string;
  actions?: ReactNode;
  children: ReactNode;
}
    ...
    <div className="app-shell">
      <header className="app-header">
        <div className="app-header-inner">
          ...
          <nav className="top-nav">
            ...
            <Link className={active === 'competitions' ? 'active' : ''} to="/competitions">
              Competitions
            </Link>
      ...
      {menuOpen && (
        <div className="mobile-nav" role="navigation" aria-label="Menu navigasi">
          ...
          <button
            type="button"
            className={`mobile-nav-link${active === 'competitions' ? ' active' : ''}`}
            onClick={() => handleMobileNav('/competitions')}
          >
