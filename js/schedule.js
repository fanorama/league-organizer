...
import { KEYS, createId, getAll, getById, save, setAll } from "./storage.js";
...
export function resolveMultiLegWinnerPublic(slot, matchRecords) {
...
export function startPlayoff(season, league) {
...
export function advancePlayoffRound(seasonId) {
...
export function finishPlayoff(seasonId, championTeamId) {
  const season = getById(KEYS.seasons, seasonId);
